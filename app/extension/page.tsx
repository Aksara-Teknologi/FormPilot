...
export default function ExtensionGuidePage() {
  return <main className="knowledge-shell">
    ...
    <section className="extension-guide">
      <article className="extension-card"><span>1</span><h2>Unduh extension</h2><p>Unduh paket extension, lalu ekstrak ZIP tersebut di komputer Anda.</p><a className="secondary-button" href="/downloads/formpilot-browser-bridge.zip" download>Unduh FormPilot Browser Bridge ↓</a></article>
      ...
      <article className="extension-card"><span>4</span><h2>Muat folder extension</h2><p>Klik <strong>Load unpacked</strong>, lalu pilih folder <code>extension</code> dari hasil ekstrak ZIP.</p></article>
